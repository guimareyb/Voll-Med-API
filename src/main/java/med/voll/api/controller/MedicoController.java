...
public class MedicoController {
    ...
    // No recomendable para la practica porque no se puede hacer Testing
    @Autowired
    ...
    @DeleteMapping("/{id}")
    @Transactional
    public ResponseEntity eliminarMédico(@PathVariable Long id){
    ...
    @DeleteMapping("/{id}")
    @Transactional
    public void eliminarMédico(@PathVariable Long id){
        Medico medico = medicoRepository.getReferenceById(id);
